 ...
 */
package tech.yobbo.engine.support.db.model;
...
public class Table implements java.io.Serializable {
    ...
    public void setTableName(String tableName) {
        ...
        this.className = StringUtils.getCamelCaseString(tableAlias, true);
        this.javaProperty = StringUtils.getCamelCaseString(tableAlias, false);
    }
    ...
    public boolean isHasRemarks() {
        return StringUtils.isNotEmpty(remarks);
    }

    public String getRemarksUnicode() {
        return StringUtils.toUnicodeString(getRemarks());
    }
